...
import { Waves, Sun, Moon, Command, UserCircle2, Bell, Menu, ShieldCheck, Settings, CreditCard, LogOut, Layout } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ currentMode, setMode, theme, toggleTheme }) => {
  ...
  const navItems = [
    ...
    { id: AppMode.STUDIO, label: 'Studio', badge: 'New' },
                        ...
                        <div className="p-4 border-b border-[#27272a]">
                            <div className="flex items-center gap-3 mb-3">
                                 ...
                                 <div>
                                     ...
                                     <div className="text-xs text-neutral-400">ADVANCE Plan</div>
                                 </div>
                            </div>
